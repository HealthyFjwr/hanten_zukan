...
ActiveRecord::Schema[7.1].define(version: 2026_04_08_000000) do
  ...
  create_table "restaurant_requests", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["status"], name: "index_restaurant_requests_on_status"
